...
#. Install the Steam Version of `Enderal: Forgotten Stories (Special Edition)`_.
#. Install `Wabbajack`_ to the base folder of one of your drives. For example: ``C:\Wabbajack`` is a safe standard. It is best installed on the same drive that you have the game installed.
